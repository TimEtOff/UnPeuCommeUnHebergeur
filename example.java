...
/*
* From Astrauworld Launcher by Tim&O
* https://github.com/AstrauworldMC/launcher/blob/main/src/fr/timeto/astrauworld/launcher/LauncherPanel.java
*/
...
public class LauncherPanel extends JPanel implements SwingerEventListener {
	...
	public void onEvent(SwingerEvent e) {
		if(e.getSource() == playButton) {
			...
			try {
                Desktop.getDesktop().browse(new URI("https://docs.google.com/document/d/1f_yL5A32Gzl1hnJ50_oRAOM7mgsefUbpCG5P29FCh_M/edit?usp=sharing"));
            } catch (IOException e1) {
                e1.printStackTrace();
            } catch (URISyntaxException e1) {
                e1.printStackTrace();
